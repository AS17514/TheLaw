...
public class Part3_3 : Part
{
    ...
    {
        base.Die();
        EventCenter.Instance.EventTrigger(E_EventType.UI_Update_EntityDied);//部位破坏时获得胜利
    }

    public override void BeAttacked(int atk)
    {
        base.BeAttacked(1);//此部位被攻击时最多只会受到1点伤害
    }
    ...
    public static void PartApear()
    {
        ...
        GameObject managerObj = new GameObject("Part3_3");

        // 关键修改 1：把新生成的组件存进一个局部变量 newPart 里
        Part3_3 newPart = managerObj.AddComponent<Part3_3>();
